        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    String title = library.getTitleFromUser();
                    String author = library.getAuthorFromUser();
                    int edition= library.getEditionFromUser();
                    ...
                    int noOfCopies= library.getCopiesFromUser();
