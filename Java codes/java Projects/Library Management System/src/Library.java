...
class Library {
    private LinkedList<Book> books;//for adding books
    private static ArrayList<Book> borrowBooks = new ArrayList<>();// to store borrow books
    private static Stack<Book> returnedBooksHistory = new Stack<Book>();
    ...
    private void editBookById(int id) {
        ...
        for (int i=0; i<books.size();i++) {
            ...
            if (book.getId() == id) {
                ...
                Book borrow;
                for (int j=0; j< borrowBooks.size();j++) {
                    borrow=  borrowBooks.get(j);
    ...
    public void displayReturnedBooks() {
        if (returnedBooksHistory.isEmpty()) {
            ...
            int bookNo=1;
            Book book;
            for (int i = 0; i< returnedBooksHistory.size(); i++) {
                book = returnedBooksHistory.get(i);
                System.out.println("Serial No : " + bookNo++);
                System.out.println("ID: " + book.getId());
                System.out.println("Title: " + book.getTitle());
                System.out.println("Author: " + book.getAuthor());
    ...
    private void getReturnedBookDetail(int id)
    {
        ...
        for (int j=0; j< borrowBooks.size();j++) {
            ...
            if (book.getId()==id)
            {
                ...
                returnedBooksHistory.push(returnBook);
                return;
            }
        }
    }
