public class BinarySearchTree {
    ...
    private BinaryNode insertAndRemoveDuplicate(BinaryNode currentNode, int value)
    {
        if (root.value==0)
        {
            root.value=value;
        ...
        {
            currentNode.left=insertAndRemoveDuplicate(currentNode.left,value);
            return currentNode;
        }
        else
        {
            currentNode.right=insertAndRemoveDuplicate(currentNode.right,value);
            return currentNode;
        }
    }

    public void insertAndRemoveDuplicate(int value)
    {
        insertAndRemoveDuplicate(root,value);
    }
